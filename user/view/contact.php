        ...
        <div class="row">
            ...
            <div id="main-outer">
                <main>
                    ...
                    <form action="../controller/contact_result_publish.php" method="post">
                        <dl>
                            <dt>
                            ...
                            <dd>
                                <input type="text" name="post-num-1" placeholder="000" id="post-num-1" required>
                                <label>
                                    －<input type="text" name="post-num-2" placeholder="0000" id="post-num-2" required>
                                </label>
                            </dd>
                            <dt>
                            ...
                            <dt>
                                <label>商品名/サービス名<span>※</span></label>
                            </dt>
                            <dd>
                                <input type="text" name="product" id="product" required>
                            </dd>
                            <dt>
                                <label for="contact-text">お問合せ内容<span>※</span></label>
                            </dt>
                            <dd>
