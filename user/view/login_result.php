    ...
    <body id="login_result">
        ...
        <div class="row">
          <nav id="global">
            ...
            <main>
              <div>
                <p>ようこそ<?php print htmlspecialchars($_SESSION['guncuber_sei']); print htmlspecialchars($_SESSION['guncuber_mei']); ?>さん</p>
                <P><a href="../controller/index_publish.php">戻る</a></p>
              </div>
            </main>
        </div>
        <footer>
